...
export default function PDFToImage() {
  ...
  return (
    <div className="max-w-4xl mx-auto px-6 py-12">
      ...
      <h1 className="text-3xl font-bold text-blue-900 mb-2">PDF to Image</h1>
      <p className="text-gray-600 mb-8">Convert PDF pages to PNG images.</p>
          ...
          {images.map((img, index) => (
            <Card key={index} className="overflow-hidden">
              ...
              <a
                ...
                className="mt-3 block text-center text-red-500 font-medium hover:underline"
              >
